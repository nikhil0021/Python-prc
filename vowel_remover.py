...
string = Entry(win_root, width=45, borderwidth=5).grid(row=1, column=0, columnspan=3, padx=10, pady=10)
magic = Button(win_root, text="Click me!!", command=rem_vow).grid(row=2, column=1)
txt = StringVar()
